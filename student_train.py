...
def main():
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, batch in tqdm(enumerate(train_loader), desc='Progress'
            ...
            self_l1_loss = l1_criterion(image_features, text_features)
            l1_loss = l1_img_loss + l1_txt_loss + l1_i2t_loss + l1_t2i_loss + self_l1_loss
            ...
            self_cos_loss = 1 - ((cosine_similarity(image_features, text_features).mean()+1)/2)
            cos_loss = cos_img_loss + cos_txt_loss + cos_i2t_loss + cos_t2i_loss + self_cos_loss

            # tript loss
            self_tript_loss = model.module.tript_loss(image_features, text_features)
            ...
            tript_loss = self_tript_loss + img_kd_tript_loss + txt_kd_tript_loss
            ...
            if not args.debug:
                wandb.log({"loss": loss, "con_loss": con_loss, "l1_loss": l1_loss, "cos_loss": cos_loss, "lr": scheduler.get_lr()[0]
                    ...
                    , "epoch": epoch, "step": i, "tript_loss": tript_loss, "img_kd_tript_loss": img_kd_tript_loss, "txt_kd_tript_loss": txt_kd_tript_loss
                    , "self_tript_loss": self_tript_loss, "self_l1_loss": self_l1_loss, "self_cos_Loss": self_cos_loss
                    })
